...
function resize_for_android_mipmap {
    ...
    announce rsvg-convert -w "$adaptiveSize" -h "$adaptiveSize" -o "android/app/src/main/res/mipmap-$sizeName/ic_launcher_foreground.png" assets/icon/icon_android_foreground.svg
    announce rsvg-convert -w "$adaptiveSize" -h "$adaptiveSize" -o "android/app/src/main/res/mipmap-$sizeName/ic_launcher_monochrome.png" assets/icon/icon_android_monochrome.svg
}
